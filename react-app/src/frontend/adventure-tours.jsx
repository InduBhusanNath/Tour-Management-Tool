           ...
           <div className="row background-cornsilk p-3">
                ...
                <div className="col-sm-10">                     
                     <p className="font font22">
                          Trying out something different has its charm. Isn’t it? So, go for a trip with our adventure tours in India in India for a memorable experience. In other words, such a package can be the perfect thing if you crave unique experiences. That way, you will experience the thrill of courageous physical activities.
                     </p>
                     <p className="font font22">
      ...
      return(<>
           ...
           <div className="row background-cornsilk p-3">
                ...
                <div className="col-sm-10">
                     ...
                     <p className="font font22">
                          These involve trekking or climbing on mountain ranges. In India, there are many spots for such activities, such as Himachal, Manali, Sikkim, Ladakh, etc.
                     </p>
      ...
      return(<>
           <div className="row background-cornsilk p-3">
                ...
                <div className="col-sm-8">
                     <h2>FAQs: FAQs: Adventure Trip Packages</h2>
                </div>
...
function SafetyConsiderations(){
      return(<>
           <div className="row background-cornsilk p-3">
               <div className="col-sm-1"></div>
               <div className="col-sm-10">
                     <h2>Safety Considerations Before Adventure Tours in India</h2>
               </div>
               <div className="col-sm-1"></div>
          </div>
          <div className="row background-cornsilk p-3">
