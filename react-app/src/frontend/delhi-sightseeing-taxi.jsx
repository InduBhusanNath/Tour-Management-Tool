      ...
      return(<>
           <div className="row background-lemonchiffon p-3">
                ...
                <div className="col-sm-10">
                     ...
                     <p className="font font22">
                          Yes, you will find good public transportation in the city. However, your travel could be uncomfortable. Metros and city buses are often crowded. Therefore, a cab can ease your tour to the important places to visit in Delhi. 
                     </p>
                     <p className="font font22">
...
function DelhiVisitingPlaces(){
      return(<>
           ...
           <div className="row background-lightyellow p-3">
                ...
                <div className="col-sm-10">
                     <p className="font font22">
                          There will be seasonal constraints to your travel. So, any time can be perfect for Delhi local sightseeing. Vibrancy remains intact at the tourist places to visit in Delhi throughout the year. Notably, you will find visitors in Delhi tourist places almost every day. So, embark upon a Delhi city tour with us.
                     </p>
                </div>
                <div className="col-sm-1"></div>
           </div>
           ...
           <div className="row background-lightyellow p-3">
                ...
                <div className="col-sm-10">
                     <figure className="float-start">              
                          <img src="https://i.postimg.cc/HWhzM5GX/LalQila.webp" alt="taxi in Delhi" className="img-fluid rounded shadow p-0 m-2"/>
                          <figcaption className="text-center">Lal Qila, New Delhi</figcaption>
                     </figure>       
                     <p className="font font22">
                          Red Fort is the English translation of Lal Qila. It is a significant historical entity in Delhi. We run a dedicated local Delhi sightseeing cab service to transport visitors to Red Fort. It is one of the most popular tourist places to visit in Delhi.
                     </p>
                     <p className="font font22">
                          Its construction has a remarkable historical angle. Mughals changed their capital from Agra to Delhi. That triggered the need to build it. You can experience its richness by visiting the historic fort. Also, you can quickly travel to the historical entity by hiring our affordable taxi service. 
                     </p>
                     <p className="font font22">
                     ...
                     <p className="font font22">
                          Red Fort should be a must to include in your Delhi city tour. 
                     </p>
                </div>
                <div className="col-sm-1"></div>
           </div>
...
function QutubMinar(){
      return(<>
           ...
           <div className="row background-lightyellow p-3">
                ...
                <div className="col-sm-10">
                     <figure className="float-start">
                          <img src="https://i.postimg.cc/50gbXPQB/Qutub-Minar.webp" alt="Delhi taxi" className="img-fluid rounded shadow p-0 m-2"/>
                          <figcaption className="text-center">Qutub Minar, New Delhi</figcaption>
                     </figure>
                     <p className="font font22">
                          The sight of the tall and iconic Qutub Minar is mentally stimulating. When you look at it from a distance, the curiosity to know how it came into being will catch your mind. It has significant historical significance. We provide the best Delhi sightseeing cab service  to transport you to the iconic site.
                     </p>
                     <p className="font font22">
                           Its height is 72.5m (238 ft). As a result, it is the world's tallest brick-built Minaret. Interestingly, it has 379 steps, signifying marvels of the technology during the Mughal times. It is one of the most important places to visit in Delhi. 
                     </p>
                     <p className="font font22">
                          You will also see various remains of structures built during the Mughal period within the vicinity of Qutub Minar. Hiring a Delhi city tour is the best option to visit the historically relevant entity. 
                     </p>                                      
                </div>                
                <div className="col-sm-1"></div>
           </div>
      ...
      return(<>
          <div className="row background-lightyellow p-3">
           ...
           <div className="row background-lightyellow p-3">
                ...
                <div className="col-sm-10">
                     <figure className="float-start">
                          <img src="https://i.postimg.cc/5yt1Lw8Z/Purana-Qila.webp" alt="taxi Delhi" className="img-fluid rounded shadow p-0 m-2"/>
